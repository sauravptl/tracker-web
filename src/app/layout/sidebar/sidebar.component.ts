    ...
    <aside class="bg-slate-900 text-white w-64 min-h-screen flex flex-col h-full shadow-2xl transition-all duration-300">
      ...
      <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto custom-scrollbar">
        ...
        <ng-container *ngIf="isAdmin()">
          ...
          <a routerLink="/settings/screenshot-settings" routerLinkActive="bg-blue-600 text-white shadow-lg shadow-blue-900/50" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-slate-800 hover:text-white transition-all duration-200 group" (click)="closeSidebar.emit()">
            <svg class="h-5 w-5 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span class="font-medium">Screenshot Settings</span>
          </a>
          <a routerLink="/settings/screenshots" routerLinkActive="bg-blue-600 text-white shadow-lg shadow-blue-900/50" class="flex items-center space-x-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-slate-800 hover:text-white transition-all duration-200 group" (click)="closeSidebar.emit()">
            <svg class="h-5 w-5 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
