                ...
                <tr *ngFor="let user of activeMembers()" class="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td *ngIf="isAdmin()" class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <select 
                      ...
                      class="ml-auto block w-32 pl-3 pr-8 py-1.5 text-sm border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 rounded-md shadow-sm disabled:bg-gray-100 disabled:text-gray-400">
